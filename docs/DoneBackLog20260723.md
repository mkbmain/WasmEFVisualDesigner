# EF Schema Visualizer — Completed Backlog (archived 2026-07-23)

> **Archived.** This file is the historical record of rounds 1–3, closed out on
> 2026-07-23 with 647 tests green at `af42ca7`. Every item below is `[x]`
> complete except the one carried forward (zip file-boundary preservation,
> now tracked as **F2/F3** in the live backlog). The active backlog is
> `docs/backlog.md`.
